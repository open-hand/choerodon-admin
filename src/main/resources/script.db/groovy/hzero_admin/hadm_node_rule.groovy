...
databaseChangeLog(logicalFilePath: 'script/db/hadm_node_rule.groovy') {
    changeSet(author: "qingsheng.chen@hand-china.com", id: "2019-01-02-hadm_node_rule") {
        ...
        createTable(tableName: "hadm_node_rule", remarks: "节点组规则配置") {
            column(name: "node_rule_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键")  {constraints(primaryKey: true)} 
            ...
            column(name: "priority", type: "int(11)",  remarks: "优先级")  {constraints(nullable:"false")}
            column(name: "enabled_flag", type: "tinyint(1)",   defaultValue:"1",   remarks: "启用禁用")  {constraints(nullable:"false")}  
