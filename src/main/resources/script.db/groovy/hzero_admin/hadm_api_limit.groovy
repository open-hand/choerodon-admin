...
databaseChangeLog(logicalFilePath: 'script/db/hadm_api_limit.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-12-30-hadm_api_limit") {
        ...
        createTable(tableName: "hadm_api_limit", remarks: "api限制规则") {
            column(name: "api_limit_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)}
            ...
            column(name: "blacklist_threshold", type: "int(11)", defaultValue: "2147483647", remarks: "黑名单阈值，单位时间窗口请求量超过该值后自动加入黑名单") {constraints(nullable:"true")}
