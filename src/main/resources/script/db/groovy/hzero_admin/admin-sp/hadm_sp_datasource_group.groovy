...
databaseChangeLog(logicalFilePath: 'script/db/hadm_sp_datasource_group.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2020-04-28-hadm_sp_datasource_group") {
        def weight = 1
        ...
        createTable(tableName: "hadm_sp_datasource_group", remarks: "逻辑数据源组") {
            column(name: "datasource_group_id", type: "bigint", autoIncrement: true, remarks: "表ID，主键") {
                constraints(primaryKey: true)
            }
            column(name: "datasource_group_name", type: "varchar(" + 30 * weight + ")", remarks: "逻辑数据源组名") {
                constraints(nullable: "false")
            }
            column(name: "description", type: "varchar(" + 240 * weight + ")", remarks: "描述说明") {
