...
databaseChangeLog(logicalFilePath: 'script/db/hadm_service_version.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-11-01-hadm_service_version") {
        ...
        createTable(tableName: "hadm_service_version", remarks: "服务版本") {
            column(name: "service_version_id", type: "bigint(20)", autoIncrement: true ,   remarks: "")  {constraints(primaryKey: true)} 
            column(name: "service_id", type: "bigint(20)",  remarks: "服务ID：hadm_service.service_id")  {constraints(nullable:"false")}
