...
databaseChangeLog(logicalFilePath: 'script/db/hadm_gw_rate_limit_dim.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2020-01-01-hadm_gw_rate_limit_dim") {
        ...
        createTable(tableName: "hadm_gw_rate_limit_dim", remarks: "网关限流设置行明细") {
            column(name: "rate_limit_dim_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)}
            column(name: "rate_limit_id", type: "bigint(20)",  remarks: "限流配置ID，hadm_gw_rate_limit.rate_limit_id")  {constraints(nullable:"false")}
            column(name: "rate_limit_line_id", type: "bigint(20)",  remarks: "限流配置行ID，hadm_gw_rate_limit_line.rate_limit_line_id")  {constraints(nullable:"false")}
