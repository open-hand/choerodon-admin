...
databaseChangeLog(logicalFilePath: 'script/db/hadm_api_monitor.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-12-30-hadm_api_monitor") {
        ...
        createTable(tableName: "hadm_api_monitor", remarks: "api监控") {
            column(name: "api_monitor_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)}
            column(name: "monitor_rule_id", type: "bigint(20)",  remarks: "api埋点ID")  {constraints(nullable:"false")}
            ...
            column(name: "max_statistics", type: "int(11)",  remarks: "单位时间窗口的最大请求数"){constraints(nullable:"false")}
            column(name: "min_statistics", type: "int(11)",  remarks: "单位时间窗口的最小请求数"){constraints(nullable:"false")}
            column(name: "sum_statistics", type: "int(11)",  remarks: "总请求数"){constraints(nullable:"false")}
            column(name: "avg_statistics", type: "int(11)",  remarks: "单位时间窗口的平均请求数"){constraints(nullable:"false")}
            column(name: "sum_failed_statistics", type: "int(11)",  remarks: "总失败请求数"){constraints(nullable:"false")}
            column(name: "avg_failed_statistics", type: "int(11)",  remarks: "单位时间窗口的平均失败请求数"){constraints(nullable:"false")}
